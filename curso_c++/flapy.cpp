#include <iostream> //created by Roy
#include <cstdlib>
#include <windows.h>
#include <conio.h>
#include <ctime>
...
void credits()
{
    ...
    {
    cout<<""<<endl<<endl;
    cout<<"               Lead programmer: roy "<<endl<<endl;
    cout<<"               Designer: roy "<<endl<<endl;
    cout<<"               Testers: roy "<<endl<<endl;
    cout<<"               Special thanks to: roy, hakeris1010 y Dong Nguyen (original)"<<endl<<endl;
    cout<<"               Version: 3.0 "<<endl<<endl<<endl;
    cout<<"Go back? [y/n]  ";
    cin>>sel;
    if(sel=='y') return;
    else system("cls");
